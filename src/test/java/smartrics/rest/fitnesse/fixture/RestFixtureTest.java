...
public class RestFixtureTest {
    ...
    public void mustUseDefaultHeadersIfDefinedOnNamedConfig() {
        ...
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "", "", ""));
        fixture.doCells(t);
        assertEquals("added1:1 does not exist", "added1:1", rClient.getRestResponse().getHeader("added1").get(0).toString());
        assertEquals("added2:2 does not exist", "added2:2", rClient.getRestResponse().getHeader("added2").get(0).toString());
    }
    ...
    public void mustAllowMultilineHeadersWhenSettingHeaders() {
        ...
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("setHeader", multilineHeaders));
        fixture.doCells(t);
        assertEquals("header1 han't been parsed and added", "one", fixture.getHeaders().get("header1"));
        assertEquals("header1 han't been parsed and added", "two", fixture.getHeaders().get("header2"));
    }

    @Test
    public void mustNotifyClientIfHTTPVerbInFirstCellIsNotSupported() {
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("IDONTEXIST", "/uri", "", "", ""));
        fixture.doCells(t);
    ...
    public void mustExecuteAnyVerbOnAnyUriWithQueryString() {
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri?a=1", "", "", ""));
        fixture.doCells(t);
        assertAllCells(t, "GET", buildResUriLink("/uri?a=1"), "<span class=\"fit_grey\">200</span>",
                "<span class=\"fit_grey\">h1&nbsp;:&nbsp;v1<br/>h2&nbsp;:&nbsp;v2<br/>Content-Type&nbsp;:&nbsp;application/xml</span>",
                "<span class=\"fit_grey\">&lt;body&gt;text&lt;/body&gt;</span>");
    ...
    public void mustMatchRequestsWithNoBodyExpressedAsNoBodyString() {
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("DELETE", "/uri", "200", "", "no-body"));
        fixture.body("<delete/>");
        fixture.doCells(t);
        assertAllCells(t, "DELETE", buildResUriLink("/uri"), "200",
                "<span class=\"fit_grey\">h1&nbsp;:&nbsp;v1<br/>h2&nbsp;:&nbsp;v2<br/>Content-Type&nbsp;:&nbsp;application/xml</span>", "no-body");
    }
    ...
    public void mustExecuteVerbOnAUriWithExcpectationsSetOnStatusCode() {
        ...
        // displayed
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "200", "", ""));
        fixture.doCells(t);
        ...
        // 'actual' is displayed...
        t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "20\\d", "", ""));
        fixture.doCells(t);
    ...
    public void mustExecuteVerbOnAUriWithExcpectationsSetOnHeaders() {
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "200", "h1 : v1", ""));
        fixture.doCells(t);
        assertAllCells(
                t,
                "GET",
        ...
        t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "200", "h1 : \\w\\d", ""));
        fixture.doCells(t);
        assertAllCells(
                t,
                "GET",
        ...
        t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "200", "h1 : \\w\\d", ""));
        fixture.doCells(t);
        assertAllCells(t, "GET", buildResUriLink("/uri"), "200", "h1 : \\w\\d", "<span class=\"fit_grey\">&lt;body&gt;text&lt;/body&gt;</span>");
    }
    ...
    public void mustExpectVerbOnFirstCell() {
        ...
        t = helper.createFitTestInstance(helper.createFitTestRow("POST", "/uri", "", "", ""));
        fixture.body("<post/>");
        fixture.doCells(t);
        assertEquals("POST", extractCell1(t));
        t = helper.createFitTestInstance(helper.createFitTestRow("DELETE", "/uri", "", "", ""));
        fixture.doCells(t);
    ...
    public void mustExecuteVerbOnAUriWithExcpectationsSetOnBody() {
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "200", "", "/body[text()='text']"));
        fixture.doCells(t);
        assertAllCells(t, "GET", buildResUriLink("/uri"), "200",
                "<span class=\"fit_grey\">h1&nbsp;:&nbsp;v1<br/>h2&nbsp;:&nbsp;v2<br/>Content-Type&nbsp;:&nbsp;application/xml</span>",
        ...
        t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "200", "", "/body[text()='text']" + System.getProperty("line.separator") + "/body"));
        fixture.doCells(t);
        assertAllCells(t, "GET", buildResUriLink("/uri"), "200",
                "<span class=\"fit_grey\">h1&nbsp;:&nbsp;v1<br/>h2&nbsp;:&nbsp;v2<br/>Content-Type&nbsp;:&nbsp;application/xml</span>",
        ...
        // actual value is displayed unless displayActualOnRight is false
        setDisplayActualOnRight(false);
        t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "200", "", "/body[text()='text']"));
        fixture.doCells(t);
        assertAllCells(t, "GET", buildResUriLink("/uri"), "200",
                "<span class=\"fit_grey\">h1&nbsp;:&nbsp;v1<br/>h2&nbsp;:&nbsp;v2<br/>Content-Type&nbsp;:&nbsp;application/xml</span>", "/body[text()='text']");
    }
    ...
    public void mustExecuteVerbOnAUriWithExcpectationsSetOnBodyInJSON() {
        ...
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "200", "", "/test[text()='me']"));
        fixture.doCells(t);
        assertAllCells(t, "GET", buildResUriLink("/uri"), "200",
        ...
        // actual value is displayed unless displayActualOnRight is false
        setDisplayActualOnRight(false);
        t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "200", "", "/test[text()='me']"));
        fixture.doCells(t);
        assertAllCells(t, "GET", buildResUriLink("/uri"), "200",
                "<span class=\"fit_grey\">h1&nbsp;:&nbsp;v1<br/>h2&nbsp;:&nbsp;v2<br/>Content-Type&nbsp;:&nbsp;application/json</span>", "/test[text()='me']");
    }

    @Test
    public void mustUseValueOnSymbolMapIfNoVariableIsFoundInTheLocalMap() {
        Fixture.setSymbol("fred", "bloggs");
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri/%fred%", "", "", ""));
        fixture.doCells(t);
    ...
    public void mustSetValueOnSymbolMapIfVariableNameStartsWith$() {
        ...
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "", "", ""));
        fixture.doCells(t);
        t = helper.createFitTestInstance(helper.createFitTestRow("let", "$content", "body", "/body/text()", "text"));
        fixture.doCells(t);
    ...
    public void mustCaptureErrorsOnExpectationsAndDisplayThemInTheSameCell() {
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "404", "", ""));
        fixture.doCells(t);
        assertAllCells(
                t,
                "GET",
    ...
    public void mustAllowStorageOfValuesExtractedViaXPathsReturningStringValues() {
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "", "", ""));
        fixture.doCells(t);
        t = helper.createFitTestInstance(helper.createFitTestRow("let", "contentCount", "body", "count(body)", "1"));
        fixture.doCells(t);
    ...
    public void mustAllowGlobalStorageOfValuesExtractedViaRegexFromHeader() {
        Parse t = helper.createFitTestInstance(helper.createFitTestRow("GET", "/uri", "", "", ""));
        fixture.doCells(t);
        t = helper.createFitTestInstance(helper.createFitTestRow("let", "val", "header", "h1:(\\w\\d)", "v1"));
        fixture.doCells(t);
